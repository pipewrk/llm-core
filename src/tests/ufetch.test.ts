...
describe("uFetch", () => {
  ...
  test("returns raw Response when returnRaw true", async () => {
  ...
  test("auto parses json when content-type present", async () => {
  ...
  test("mapJson applied when provided", async () => {
  ...
  test("parseJson=false but json content-type skipped", async () => {
